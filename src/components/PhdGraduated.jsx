...
const PhdGraduated = () => {
  ...
  const [no_of_journal_papers, setJournalPapers] = useState("");
  const [no_of_conference_papers, setConferencePapers] = useState("");
  ...
  const handleJournalPapersChange = (e) => setJournalPapers(e.target.value);
  const handleConferencePapersChange = (e) =>
    setConferencePapers(e.target.value);
  const handleCurrentWorkingStatusChange = (e) =>
    setCurrentworkingstatus(e.target.value);
  const handlePlaceOfWorkChange = (e) => setPlaceofwork(e.target.value);
  ...
  const handleSelectData = (data) => {
    ...
    toast.info(
      `Selected data: ${data.name} - ${data.graduating_year} - ${data.no_of_journal_papers} journal papers - ${data.no_of_conference_papers} conference papers - ${data.thesis_title} - ${data.current_working_status} - ${data.place_of_work} - ${data.enrolledIn}`,
      {
        autoClose: false,
        closeOnClick: true,
        ...
        onOpen: () => {
          ...
          setJournalPapers(data.no_of_journal_papers || "");
          setConferencePapers(data.no_of_conference_papers || "");
          setCurrentworkingstatus(data.current_working_status || "");
          setPlaceofwork(data.place_of_work || "");
          setInfo(data.info || "");
        },
      }
    );
  ...
  const fetchData = async () => {
    try {
      ...
      const phdData = data.filter((data) => data.enrolledIn === "PhD Scholar");
      setActiveForm(null); // Reset activeForm state
      setSearchPerformed(true);
      setSearchResults(phdData); // Assuming data is an array of data objects matching the search query
      setTotalStudents(phdData.length);
    } catch (error) {
        ...
        return (
          <div style={styles.formContainer}>
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <div style={styles.formGroup}>
                <label htmlFor="no_of_journal_papers" style={styles.label}>
                  Add No. of Journal Papers
                  <span style={styles.labelRequired}>*</span>
                </label>
                <input
                  type="number"
                  id="no_of_journal_papers"
                  value={no_of_journal_papers}
                  onChange={handleJournalPapersChange}
                  style={styles.input}
                />
              </div>
              <div style={styles.formGroup}>
                <label htmlFor="no_of_conference_papers" style={styles.label}>
                  Add No. of Conference Papers
                  <span style={styles.labelRequired}>*</span>
                </label>
                <input
                  type="number"
                  id="no_of_conference_papers"
                  value={no_of_conference_papers}
                  onChange={handleConferencePapersChange}
                  style={styles.input}
                />
              </div>
              <div style={styles.formGroup}>
              ...
              <div style={styles.formGroup}>
                <label htmlFor="place_of_work" style={styles.label}>
                  Add Place of Work<span style={styles.labelRequired}>*</span>
                </label>
                <input
                  type="text"
                  id="place_of_work"
                  ...
                  {searchResults.map((data) => (
                    ...
                    >
                      <div style={styles.containerbox}>
                        ...
                        <p>
                          Number of Journal Papers: {data.no_of_journal_papers}
                        </p>
                        <p>
                          Number of Conference Papers:{" "}
                          {data.no_of_conference_papers}
                        </p>
                        <p>
                          Current Working Status: {data.current_working_status}
                        </p>
                        <p>Place of Work: {data.place_of_work}</p>
